...
std::pair<int, int> divide_remainder(int dividend, int divisor)
{
    ...
    return std::make_pair<int, int>(dividend / divisor, dividend % divisor);
}
int main()
{
    {
    ...
    //C++ 17 decomopose a tuple into individual vars
    {
    ...
    {
        const auto &[fraction, remainder] = divide_remainder(16, 5);
        std::cout << "16 % 5 is " << fraction  <<" with a remainder of " <<  remainder << "\n";
    }
    //C++ 17 use structured bingding in for-loop
    {
